...
# 模块 -> 必需 CONFIG 选项
declare -A REQUIRED
REQUIRED[gpio]="CONFIG_LS2K300_GPIO CONFIG_LS2K300_PINCTRL"
REQUIRED[i2c]="CONFIG_LS2K300_I2C CONFIG_LS2K300_I2C1 CONFIG_I2C_DRIVER CONFIG_LS2K300_PINCTRL"
REQUIRED[spi]="CONFIG_LS2K300_SPI CONFIG_LS2K300_SPIIO2"
REQUIRED[adc]="CONFIG_LS2K300_ADC"
REQUIRED[pwm]="CONFIG_LS2K300_PWM CONFIG_LS2K300_PWM2 CONFIG_LS2K300_PINCTRL"
REQUIRED[uart]="CONFIG_LS2K300_UART2 CONFIG_LS2K300_GPIO CONFIG_LS2K300_PINCTRL"
...
if [ "$ERRORS" -gt 0 ]; then
  ...
  echo "提示: CONFIG_LS2K300_PINCTRL=y 缺失则 /dev/pinctrl0 不被创建。" >&2
  echo "提示: UART 仅开 CONFIG_LS2K300_UARTn 不够，还需内核 ls2k300_serial.c" >&2
